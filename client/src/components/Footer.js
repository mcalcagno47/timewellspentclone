      ...
      <div className="mx-auto w-full container p-4 sm:p-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a
              href="https://github.com/TotallyReactingNodeTurtles/timewellspent"
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/JIoriatti"
                    className="hover:underline"
                  >
                    James I.
                  </a>
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/mcalcagno47"
                    className="hover:underline"
                  >
                    Mark C.
                  </a>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a
                    href="https://github.com/TotallyReactingNodeTurtles"
                    className="hover:underline "
                  >
                    Github
                  </a>
                ...
                <li>
                  <a
                    href="https://discord.com/channels/1022602608004841512/1022602608348762136"
                    className="hover:underline"
                  >
                    Discord
                  </a>
